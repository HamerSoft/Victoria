...
mkdir -p Packages/com.hamersoft.victoria
mv ./Editor Packages/com.hamersoft.victoria
mv ./Runtime Packages/com.hamersoft.victoria
mv ./Tests Packages/com.hamersoft.victoria
mv package.json Packages/com.hamersoft.victoria/package.json

touch Packages/manifest.json
json='{
        "dependencies": {
          "com.hamersoft.victoria": "file:com.hamersoft.victoria",
